  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/renderer/components/VoiceInput/CloudAsrProvider.ts',
        'src/renderer/components/VoiceInput/WebSpeechProvider.ts',
        'src/renderer/components/VoiceInput/useTranscriber.ts',
