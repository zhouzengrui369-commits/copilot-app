...
export const IPC_CHANNELS = {
  ...
  ASK_CONVERSATION_SAVE: 'copilot:ask-conversation:save',
  ASK_CONVERSATION_LOAD: 'copilot:ask-conversation:load',
  ASK_CONVERSATION_CLEAR: 'copilot:ask-conversation:clear',
