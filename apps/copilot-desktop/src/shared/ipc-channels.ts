...
export const IPC_CHANNELS = {
  ...
  LOCAL_ASR_STATUS: 'copilot:local-asr:status',
  LOCAL_ASR_DECODE: 'copilot:local-asr:decode',
  LOCAL_ASR_CANCEL: 'copilot:local-asr:cancel',
  ...
  NOTES_CREATE_WITH_BUILD: 'copilot:notes:create-with-build',
  NOTES_UPDATE: 'copilot:notes:update',
  NOTES_UPDATE_WITH_BUILD: 'copilot:notes:update-with-build',
  NOTES_REMOVE: 'copilot:notes:remove',
  NOTES_GET_BACKLINKS: 'copilot:notes:get-backlinks',
  WIKI_GET_FOR_NOTE: 'copilot:wiki:get-for-note',
